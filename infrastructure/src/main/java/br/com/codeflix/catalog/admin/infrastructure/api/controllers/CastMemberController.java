...
import br.com.codeflix.catalog.admin.infrastructure.castmember.presenters.CastMemberPresenter;
...
public class CastMemberController implements CastMemberAPI {
    ...
    public CastMemberController(final DefaultCreateCastMemberUseCase createCastMemberUseCase,
                                final DefaultDeleteCastMemberUseCase deleteCastMemberUseCase,
                                final DefaultGetCastMemberByIdUseCase getCastMemberByIdUseCase,
                                final DefaultListCastMembersUseCase listCastMembersUseCase,
                                final DefaultUpdateCastMemberUseCase updateCastMemberUseCase) {
    ...
    public CastMemberResponse getById(final String id) {
        return CastMemberPresenter.present
